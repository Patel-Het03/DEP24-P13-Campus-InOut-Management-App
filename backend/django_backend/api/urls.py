...
urlpatterns = [
    ...
    path('students/get_authority_tickets_for_students',
         get_authority_tickets_for_students),
    path('students/change_profile_picture_of_student',
         change_profile_picture_of_student),
    ...
    path('guards/change_profile_picture_of_guard',
         change_profile_picture_of_guard),
    path('guards/get_all_guards', get_all_guards),

    # Visitors
    path('visitors/insert_in_visitors_ticket_table',
         insert_in_visitors_ticket_table),
    path('visitors/insert_in_visitors_ticket_table_2',
         insert_in_visitors_ticket_table_2),
    path('visitors/get_list_of_visitors', get_list_of_visitors),
    path('visitors/get_pending_tickets_for_visitors',
         get_pending_tickets_for_visitors),
    path('visitors/get_pending_visitor_tickets_for_authorities',
         get_pending_visitor_tickets_for_authorities),
    path('visitors/get_past_visitor_tickets_for_authorities',
         get_past_visitor_tickets_for_authorities),
    path('visitors/accept_selected_tickets_visitors',
    ...
    # Authorities
    path('authorities/accept_selected_tickets_authorities',
         accept_selected_tickets_authorities),
    path('authorities/reject_selected_tickets_authorities',
         reject_selected_tickets_authorities),
    # To find "Pending" tickets for given authority email
    path('authorities/get_pending_tickets_for_authorities',
    ...
    path('authorities/insert_in_authorities_ticket_table',
         insert_in_authorities_ticket_table),
    path('authorities/get_authority_tickets_with_status_accepted',
         get_authority_tickets_with_status_accepted),

    path('authorities/change_profile_picture_of_authority',
    ...
    # To find "Accepted"|"Rejected" tickets for given authority email
    path('admins/change_profile_picture_of_admin',
         change_profile_picture_of_admin),
    # Get the list of all admins
    path('admins/get_all_admins', get_all_admins),

    # Statistics
    path('statistics/get_statistics_data_by_location',
         get_statistics_data_by_location),
    path('statistics/get_piechart_statistics_by_location',
    ...
    path('notification/mark_individual_notification/',
         mark_individual_notification),
    path('notification/insert_notification_guard_accept_reject/',
